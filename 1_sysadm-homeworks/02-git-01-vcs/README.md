...
Задание выполнено.
Ссылка на репозиторий: [github.com...tology.git](https://github.com/alniger/devops-netology.git)
В файле README.md описывается какие файлы будут проигнорированы согласно .gitignore.